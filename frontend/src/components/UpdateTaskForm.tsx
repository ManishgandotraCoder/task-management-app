...
import { updateTaskSchema, type UpdateTaskFormData } from '@/lib/schemas';
...
export function UpdateTaskForm() {
    ...
    useEffect(() => {
        ...
        reset({
            ...
            priority: selectedTask.priority as TaskPriority | null,
    ...
    if (loading && !selectedTask) {
        return (
            <div className="flex justify-center py-12" role="status" aria-label="Loading task">
